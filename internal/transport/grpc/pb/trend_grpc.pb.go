...
const (
	TrendService_GetTopN_FullMethodName = "/trendservice.TrendService/GetTopN"
)
...
func (c *trendServiceClient) GetTopN(ctx context.Context, in *GetTopNRequest, opts ...grpc.CallOption) (*GetTopNResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTopNResponse)
	err := c.cc.Invoke(ctx, TrendService_GetTopN_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTrendServiceServer) GetTopN(context.Context, *GetTopNRequest) (*GetTopNResponse, error) {
...
func _TrendService_GetTopN_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTopNRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrendServiceServer).GetTopN(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TrendService_GetTopN_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrendServiceServer).GetTopN(ctx, req.(*GetTopNRequest))
	}
...
var TrendService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "trendservice.TrendService",
	HandlerType: (*TrendServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTopN",
			Handler:    _TrendService_GetTopN_Handler,
		},
	},
